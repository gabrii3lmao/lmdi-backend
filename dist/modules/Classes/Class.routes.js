...
classRouter.get("/", authMiddleware, validate(paginationQuerySchema, "query"), classController.getClasses);
classRouter.post("/", authMiddleware, validate(classValidationSchema), classController.createClass);
classRouter.put("/:id", authMiddleware, validate(classValidationSchema), classController.updateClass);
